...
export default function Card({ icon, title, description, className, titleStyle, descriptionStyle }: CardProps) {
    ...
    return (
        <div className={`border bg-white-1 border-slate-300 rounded-md p-6 my-1 lg:my-2 min-w-1/5 flex flex-col gap-4 ${className}`} role="group" aria-labelledby={titleId}>
